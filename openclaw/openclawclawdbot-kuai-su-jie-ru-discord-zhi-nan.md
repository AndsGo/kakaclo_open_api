...
<img src="../.gitbook/assets/0 (10)" alt="0" height="182" width="1148">

配置模式选择：快速入门接下来需要选择Onboarding的模式，我们选择QuickStart。

<img src="../.gitbook/assets/0 (11)" alt="0" height="154" width="442">

配置处理方式选择 Use existing values

<img src="../.gitbook/assets/0 (12)" alt="0" height="254" width="598">
...
<img src="../.gitbook/assets/0 (13)" alt="0" width="354">

All providers

<img src="../.gitbook/assets/0 (14)" alt="0" width="393">
...
<img src="../.gitbook/assets/0 (18)" alt="0" height="146" width="692">

访问权限模式选择 Open(allow all channels)

<img src="../.gitbook/assets/0 (19)" alt="0" height="214" width="650">
...
<img src="../.gitbook/assets/0 (20)" alt="0" height="164" width="748">
...
<img src="../.gitbook/assets/0 (21)" alt="0" height="330" width="1396">

安装完成选择 Restart

<img src="../.gitbook/assets/0 (22)" alt="0" height="238" width="800">

启动方式选择 Do this later

<img src="../.gitbook/assets/0 (23)" alt="0" height="248" width="798">

安装命令补全功能选择 No注意：此处如果选择Yes，后续OpenClaw运行的时候容易导致服务器CPU负载高，导致OpenClaw运行出问题。

<img src="../.gitbook/assets/0 (24)" alt="0" height="224" width="708">
...
<img src="../.gitbook/assets/0 (27)" alt="0" height="594" width="824">
